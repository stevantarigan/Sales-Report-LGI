...
@section('title', 'Edit Product | SuperAdmin')
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control readonly-field" id="sku" 
                ...
                <div class="form-group">
                    ...
                    <div class="price-input-group">
                        <input type="number" class="form-control" id="cost_price" name="cost_price" 
                               step="0.01" min="0" value="{{ old('cost_price', $product->cost_price) }}">
                    </div>
                    @error('cost_price')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="min_stock" name="min_stock" 
                           min="0" value="{{ old('min_stock', $product->min_stock) }}" required>
                    @error('min_stock')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($product->image)
                        <img src="{{ asset('storage/' . $product->image) }}" 
                             alt="{{ $product->name }}" 
                             class="image-preview"
                             onerror="this.style.display='none'; document.getElementById('noImageMessage').style.display='block';">
                        <div id="noImageMessage" style="display: none; text-align: center; color: #64748b;">
        ...
        <div class="form-section">
            ...
            <div class="specifications-container" id="specificationsContainer">
                @php
                    ...
                    $specCount = count($specifications) > 0 ? count($specifications) : 1;
                @endphp
                
                @foreach($specifications as $key => $value)
                    <div class="spec-row">
                        <div class="form-group">
                            <input type="text" class="form-control" name="specifications[{{ $key }}][key]" 
    ...
    function resetForm() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Reset specifications to original state
                const container = document.getElementById('specificationsContainer');
                container.innerHTML = `
                    <div class="spec-row">
                        <div class="form-group">
