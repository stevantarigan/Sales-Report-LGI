...
@section('title', 'Customer Details | ' . ucfirst(auth()->user()->role))
            ...
            <div class="flex-grow-1">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <span class="type-badge badge-{{ $customer->type_color }}">
        ...
        <div class="col-lg-8">
            ...
            <div class="detail-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-grid" style="grid-column: 1 / -1; width: 100%;">
                        @if ($customer->city)
                            <div class="info-item">
                    ...
                    <div class="info-grid">
                        <div class="info-item" style="grid-column: 1 / -1;">
                            ...
                            <div class="info-value"
                                style="font-weight: normal; line-height: 1.5; background: #f8fafc; padding: 1rem; border-radius: 8px;">
                                {{ $customer->notes }}
                            </div>
                        </div>
                    </div>
